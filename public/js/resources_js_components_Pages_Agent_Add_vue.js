...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    addAgent: function addAgent() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().post('add-agent', data, config).then(function (response) {
...
var staticRenderFns = [
  function () {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "mt-5 form-group row" }, [
