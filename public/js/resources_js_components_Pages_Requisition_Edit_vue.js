...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    updateRequisition: function updateRequisition() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_3___default().post("update-requisition/".concat(id), this.form).then(function (response) {
        Toast.fire({
          icon: 'success',
          title: response.data.msg
        });
  ...
  computed: {
    sector_of_company: function sector_of_company() {
      ...
      return this.companysectors.filter(function (item) {
        return item.company_id === _this3.form.company_id.id;
      });
    }
  },
  mounted: function mounted() {
    ...
    var id = this.$route.params.id;
    axios__WEBPACK_IMPORTED_MODULE_3___default().get("edit-requisition/".concat(id)).then(function (res) {
      _this4.form = res.data.requisition;
      _this4.form.company_id = res.data.company;
      _this4.form.sector_id = res.data.sector;
    });
    axios__WEBPACK_IMPORTED_MODULE_3___default().get('companies').then(function (response) {
      _this4.companies = response.data.companies;
    });
    axios__WEBPACK_IMPORTED_MODULE_3___default().get('sectors').then(function (response) {
      _this4.companysectors = response.data;
    });
