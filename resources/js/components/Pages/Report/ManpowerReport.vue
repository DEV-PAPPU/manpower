    ...
    <div class="">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-white">Man Power Report</h6>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input v-model="form.mp_date" class="form-control" type="date">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input v-model="form.mp_end_date" class="form-control" type="date">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                         ...
                         <div class="col-md-3">
                            <div class="form-group">
                                <label for="PassengerName">Man Power Status</label>
                                 <select v-model="form.mp_status"  class="form-control filter-select">
                                    <option value="">-- Select --</option>
                    ...
                    <table class="table table-hover table-bordered dbtable">
                        <thead>
                            <tr>
                                ...
                                <th style="width:150px">STM Status</th>
                                <th style="width:150px">Man Power Status</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr v-for="item in passengers" :key="item.id">
                                ...
                                <td>{{item.visa_no}}</td>
                                <td>{{item.trade}}</td>                                
                                <td>Complete Date: {{item.stm_passport_complete_date}}</td>                                
                                <td>
                                    <span v-if="item.man_power_passport_status == '1'">Complete Date: {{item.man_power_passport_complete_date}} </span>

                                    <span v-else>Processing  <i @click="mpProcessDate(item.man_power_id)" class="fas fa-calendar-alt cursor edit_icon" data-toggle="modal" data-target="#exampleModalCenter" ></i> </span>
                                </td>                                
                            </tr>
    ...
    methods:{
        filterData(){
               ...
               let data = new FormData();
                data.append('mp_date', this.form.mp_date);
                data.append('mp_end_date', this.form.mp_end_date);
                ...
                data.append('mp_status', this.form.mp_status);
                data.append('p_c', this.form.p_c);
                data.append('t_c', this.form.t_c);

                

            axios.post('filter/mp', data).then(res =>{
