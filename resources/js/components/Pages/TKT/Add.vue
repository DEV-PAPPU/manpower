    ...
    <div class="">
        <div class="card shadow mb-4">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-white">TKT Entry</h6>
...
export default {
    ...
    methods:{
        ...
        searchPassport(){
            ...
            axios.post('tkt/search-passport', this.searchFrom).then(res =>{
               ...
               Toast.fire({
                ...
                axios.post('tkt/add-passport',{
                    ...
                    if(res.data.msg){
                        ...
                        this.$router.push({name:'TKTLists'});
                   }
