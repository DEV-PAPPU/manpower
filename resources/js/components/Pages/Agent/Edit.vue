                              ...
                              <div class="form-group row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" v-model="form.agent_name" placeholder="Please enter name" type="text" >
                                            <small v-if="errors.agent_name" class="form-text text-danger">{{ errors.agent_name[0] }}</small>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                         <div class="form-group">
                                            <label for="agent_email">agent_email</label>
                                            <input class="form-control" v-model="form.agent_email" placeholder="Please enter agent_email " type="agent_email" >
                                            <small v-if="errors.agent_email" class="form-text text-danger">{{ errors.agent_email[0] }}</small>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="Peragent_address">agent_phone No (Primary)</label>
                                            <input class="form-control" v-model="form.agent_phone" placeholder="Please enter agent_phone" type="text" >
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <label for="Peragent_address">agent_area</label>
                                            <input class="form-control" v-model="form.agent_area" placeholder="Please enter agent_area" type="text" >
                                     ...
                                     <div class="col-md-7">
                                        <div class="form-group">
                                            <label for="Peragent_address">Office agent_address</label>
