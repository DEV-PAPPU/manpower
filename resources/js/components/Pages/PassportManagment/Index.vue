    ...
    <div>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-white">Passport List</h6>
                        ...
                        <tbody>
                            <tr v-for="item in passengers" :key="item.id">
                                ...
                                <td>
                                    ...
                                    <button @click="viewMore(item)" data-toggle="modal" data-target="#exampleModalCenter" ><i class="edit_icon fas fa-align-justify"></i></button>
                                </td>
                            </tr>
