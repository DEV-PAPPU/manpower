                            ...
                            <tbody>
                                <tr v-for="country in country" :key="country.id">
                                    ...
                                    <td>
                                        ...
                                        <a href="#" @click="deletesetor(country)"><i
                        ...
                        <div class="form-group">
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select v-model="form.sector" multiple="true" class="form-control filter-select">
...
export default {
    ...
    methods:{
        ...
        //     axios.get(`checking-country-sectors/${id}`).then(res =>{
                   
        //            let  old_sector = res.data;
                
        //             old_sector.forEach(sector =>{
        //                 new_sector.push(sector)
        //             })

        //                 new_sector.forEach((c) => {
