                        ...
                        <table class="table table-hover table-bordered dbtable">
                            ...
                            <tbody>
                                <tr v-for="item in passengers" :key="item.id">
                                    <td>{{item.id}}</td>
                                    <td>{{item.passenger_name}} <br> {{item.passenger_date_of_birth}}</td>
                                    <td> 
                                        <div>
                                            <span>No: </span>{{item.passport_no}}
                                        </div>
                                        <div>
                                            <span>Exp. Dt: </span>{{item.passport_expire_date}}
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <router-link :to="{name: 'PassengerEdit', params: {id: item.id}}"><i class="far edit_icon fa-edit"></i></router-link>
