    ...
    <div class="">
        <div class="card shadow mb-4">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-white">Passenger Edit</h6>
                        ...
                        <form @submit.prevent="updatePassenger">
                            <div class="form-group row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input v-model="form.passenger_name" class="form-control"  type="text">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="FatherName">Father's Name </label>
                                        <input v-model="form.passenger_father_name" class="form-control"   type="text">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input v-model="form.passport_no" class="form-control"  type="text">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                 <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select v-model="form.passenger_gender" class="form-control filter-select"  >
                                ...
                                <div class="col-md-3">
                                 ...
                                 <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <select v-model="form.passport_source"  class="form-control filter-select" >
                                            <option value="">-- Select --</option>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="" v-model="form.passenger_note" class="form-control" id="" cols="30" rows="7"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" v-model="form.passenger_discount" type="number">
...
export default {
    ...
    methods:{
        ...
        updatePassenger(){
            ...
            axios.post(`update-passenger/${id}`, data).then(response =>{
    ...
    mounted(){
        ...
        let id = this.$route.params.id;
        axios.get(`edit-passenger/${id}`).then(res =>{
            let passenger = res.data.passenger;
          
          this.form.passenger_name = passenger.passenger_name;
            this.form.passenger_father_name = passenger.passenger_father_name;
            this.form.passenger_phone = passenger.passenger_phone;
            this.form.passport_no = passenger.passport_no;
            this.form.passport_source = passenger.passport_source;
            this.form.passenger_gurdian_no = passenger.passenger_gurdian_no;
            this.form.passenger_date_of_birth = passenger.passenger_date_of_birth;
            this.form.passport_expire_date = passenger.passport_expire_date;
            this.form.old_passport_no = passenger.old_passport_no;
            this.form.passenger_gender = passenger.passenger_gender;
            this.form.passenger_note = passenger.passenger_note;
            this.form.passenger_discount = passenger.passenger_discount;
